  ...
  return (
    <>
      ...
      <footer className="footer">
        <div className="container container-spacing lg footer-container">
          {/* Logo + Bio */}
          <div className="footer-column">
            <h2 className="footer-logo">Lehhril<span className="dot">.</span></h2>
        ...
        <div className='footer-bottom text-center'>
            <p>@ 2025 Lehhril Chauadhary. All rights reserved.</p>
        </div>
      </footer>
    </>
  )
