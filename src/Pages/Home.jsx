                ...
                <div className="container">
                    <div className="banner-main">
                        ...
                        <Threads
                            ...
                            color={[155 / 255, 93 / 255, 229 / 255]} // ≈ [0.0627, 0.0901, 0.1568]
                        />
                    </div>
                </div>
            </section>
                ...
                <div className="container container-spacing">
                    ...
                    <div className="single-grid-item">
                        <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(54, 18, 95, 0.6)">
                            ...
                            <div className="card-details">
                                <p>
                                    Fully invested in every line of code, with an eye for detail and a commitment to delivering polished, production-ready web solutions.
                                </p>
                            </div>
                        </SpotlightCard>
                    </div>
